...
var filePath = path.join(__dirname, "..", "data", "restaurants.json");
var fileData = fs.readFileSync(filePath).toString();
var storedRestaurants = JSON.parse(fileData);
app.get("/about", function (req, res) {
    res.render("about");
});
app.get("/confirm", function (_, res) {
    res.render("confirm");
});
app.get("/", function (req, res) {
    res.render("index", {
        listBoarding: new Map([
...
app.get("/restaurants", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
